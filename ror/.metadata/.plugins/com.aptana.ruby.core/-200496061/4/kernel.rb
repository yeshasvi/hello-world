module Kernel
  ...
  RUBYGEMS_ACTIVATION_MONITOR = #<Monitor:0x00000102074c68 @mon_owner=nil, @mon_count=0, @mon_mutex=#<Mutex:0x00000102074c18>>
  ...
  def self.caller_locations(arg0, arg1, *rest)
  end
  ...
  def caller_locations(arg0, arg1, *rest)
  end
